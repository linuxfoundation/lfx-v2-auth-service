...
> **Local development only.** This implementation is intentionally scoped to local development environments and is **not suitable for production**. See [Known Limitations](#known-limitations) below.
